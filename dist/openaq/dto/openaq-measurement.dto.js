...
exports.OpenAQMeasurementDto = void 0;
const swagger_1 = require("@nestjs/swagger");
class OpenAQMeasurementDto {
    stationId;
    parameterId;
    value;
    dateUtc;
}
exports.OpenAQMeasurementDto = OpenAQMeasurementDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Station ID' }),
    __metadata("design:type", Number)
], OpenAQMeasurementDto.prototype, "stationId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Parameter ID' }),
    __metadata("design:type", Number)
], OpenAQMeasurementDto.prototype, "parameterId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Measured value' }),
    __metadata("design:type", Number)
], OpenAQMeasurementDto.prototype, "value", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'UTC timestamp of measurement' }),
